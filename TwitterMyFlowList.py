...
takipcilerim = driver.find_element_by_xpath("//*[@id='react-root']/div/div/div[2]/main/div/div/div/div[1]/div/div[2]/div/div/div[1]/div/div[5]/div[2]/a")
takipcilerim.click()
time.sleep(1)
...
while True:
    ...
    for i in FlowList:   
        ...
        print(takip)
        sql = "INSERT INTO takipettiklerim (takipettiklerim) VALUES (%s)"
        val = (takip)
